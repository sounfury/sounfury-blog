...
public interface SysOssService {
     ...
     * @return 结果
     */
    PageRepDto<SysOssDto> queryPageList(SysOssReq sysOss, PageReqDto pageQuery);
     ...
     */
    List<SysOssDto> listByIds(Collection<Long> ossIds);
