...
public class ArticlePageRep {
    ...
    public ArticlePageRep(Article article){
    ...
    public static final RecordMapper<Record, ArticlePageRep> MAPPER = record -> ArticlePageRep.builder()
