package org.sounfury.core.convention.errorcode;
...
public enum BaseErrorCode implements IErrorCode {
    ...
    // ========== 二级宏观错误码 用户频繁请求错误 ==========
    FLOW_LIMIT_ERROR("A000300", "用户请求过于频繁"),

    // ========== 二级宏观错误码 用户权限校验错误 ==========
    // 认证相关错误码
    HTTP_FORBIDDEN("A000401", "没有访问权限，请联系管理员授权"),
    HTTP_UNAUTHORIZED("A000402", "认证失败，无法访问系统资源"),
